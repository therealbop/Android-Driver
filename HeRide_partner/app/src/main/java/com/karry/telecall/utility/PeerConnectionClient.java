...
public class PeerConnectionClient {
    ...
    private VideoTrack remoteVideoTrackHeader;
    private VideoRenderer.Callbacks remoteRenderHeader;
    ...
    public void createPeerConnection(
            ...
            final VideoRenderer.Callbacks remoteRender, final VideoRenderer.Callbacks remoteRenderHeader,
        ...
        this.remoteRenderHeader = remoteRenderHeader;
    ...
    public void setVideoEnabled(final boolean enable) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (remoteVideoTrackHeader != null) {
                    remoteVideoTrackHeader.setEnabled(renderVideo);
                }
            ...
            executor.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    if (stream.videoTracks.size() == 1) {
                        ...
                        remoteVideoTrackHeader = stream.videoTracks.get(0);
                        remoteVideoTrackHeader.setEnabled(renderVideo);
                        remoteVideoTrackHeader.addRenderer(new VideoRenderer(remoteRenderHeader));
...
//    public void addLocalVideoTrack() {
//
//
